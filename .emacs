...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil-surround telephone-line smart-mode-line vdiff-magit vdiff evil-magit git-gutter magit evil-commentary projectile general which-key doom-themes evil use-package))))
(custom-set-faces
